            ...
            <div class="container-fluid main-container">
                <div class="d-flex">
                    ...
                    <a class="logo-horizontal " href="index.html">
                        <img src="/dashboard/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo"
                             alt="logo">
                        <img src="/dashboard/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                    <!-- LOGO -->
                                ...
                                <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            ...
                                            <div class="header-dropdown-list message-menu">
                                                <div class="dropdown-item d-flex p-4">
                                                    ...
                                                    <span
                                                        class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/products/3.jpg" alt="" >
                                                        </span>
                                                    <div class="wd-50p">
                                                ...
                                                <div class="dropdown-item d-flex p-4">
                                                    ...
                                                    <span
                                                        class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/products/42.jpg" alt="">
                                                        </span>
                                                    <div class="wd-50p">
                                                ...
                                                <div class="dropdown-item d-flex p-4">
                                                    ...
                                                    <span
                                                        class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/products/43.jpg" alt="">
                                                        </span>
                                                    <div class="wd-50p">
                                                ...
                                                <div class="dropdown-item d-flex p-4">
                                                    ...
                                                    <span
                                                        class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/products/44.jpg" alt="">
                                                        </span>
                                                    <div class="wd-50p">
                                                ...
                                                <div class="dropdown-item d-flex p-4">
                                                    ...
                                                    <span
                                                        class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/products/45.jpg" alt="" class="">
                                                        </span>
                                                    <div class="wd-50p">
                                                ...
                                                <div class="d-flex align-items-start dropdown-item">
                                                    <div class="flex-grow-1">
                                                        <div
                                                            ...
                                                            <a href="index.html#" class="text-danger p-0"><i
                                                                    class="fe fe-x"></i></a>
                                                        </div>
                                                        <a href="index.html"
                                            ...
                                            <div class="message-menu message-menu-scroll">
                                                <a class="dropdown-item d-flex" href="private-chat.html">
                                                        <span
                                                            ...
                                                            <img src="/dashboard/assets/images/profiles/1.jpg" alt="">
                                                        </span>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a class="dropdown-item d-flex" href="private-chat.html">
                                                        <span
                                                            class="avatar avatar-md  me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/profiles/15.jpg" alt="">
                                                        </span>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a class="dropdown-item d-flex" href="private-chat.html">
                                                        <span
                                                            class="avatar avatar-md  me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/profiles/12.jpg" alt="">
                                                        </span>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                ...
                                                <a class="dropdown-item d-flex" href="private-chat.html">
                                                        <span
                                                            class="avatar avatar-md  me-3 align-self-center cover-image">
                                                            <img src="/dashboard/assets/images/profiles/3.jpg" alt="">
                                                        </span>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                    ...
                                    <div class="dropdown d-flex profile-1">
                                        <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link user-dropdown">
                                            <img src="/dashboard/assets/images/profiles/5.jpg" alt="profile-user" class="profile-user avatar  cover-image">
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="index.html">
                        <img src="/dashboard/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo"
                             alt="logo">
                        <img src="/dashboard/assets/images/brand/icon-white.png" class="header-brand-img toggle-logo"
                             alt="logo">
                        <img src="/dashboard/assets/images/brand/icon-dark.png" class="header-brand-img light-logo"
                             alt="logo">
                        <img src="/dashboard/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active">
                                                <ul class="sidemenu-list">
                                                    ...
                                                    <li><a href="index.html" class="slide-item">CRM</a></li>
                                                    <li><a href="dashboard-analytics.html" class="slide-item">Analytics</a></li>
                                                    <li><a href="dashboard-ecommerce.html" class="slide-item">eCommerce</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active">
                                                <ul class="sidemenu-list">
                                                    ...
                                                    <li><a href="ecommerce-product-add.html" class="slide-item">Add
                                                            Product</a></li>
                        ...
                        <li class="slide">
                            <a class="sidenav-menu-item" href="../documentation/index.html"><i class="side-menu__icon  ti ti-book"></i><span class="side-menu__label">Documentation</span>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                <div>Copyright © <span id="year"></span> <a href="javascript:void(0)">Apexadmin</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> techneinfosys </a> All rights reserved.</div>
            </div>
        </div>
    </div>
</footer>
...
<!--{ SPARKLINE JS }-->
<script src="/dashboard/assets/js/jquery.sparkline.min.js"></script>
<!--{ Sticky js }-->
<script src="/dashboard/assets/js/sticky.js"></script>
<!--{ CHART-CIRCLE JS }-->
<script src="/dashboard/assets/js/circle-progress.min.js"></script>
<!--{ PIETY CHART JS }-->
<script src="/dashboard/assets/js/plugins/peitychart/jquery.peity.min.js"></script>
<script src="/dashboard/assets/js/plugins/peitychart/peitychart.init.js"></script>
<!--{ SIDEBAR JS }-->
<script src="/dashboard/assets/js/plugins/sidebar/sidebar.js"></script>
<!-- Perfect SCROLLBAR JS-->
<script src="/dashboard/assets/js/plugins/p-scroll/perfect-scrollbar.js"></script>
<script src="/dashboard/assets/js/plugins/p-scroll/pscroll.js"></script>
<script src="/dashboard/assets/js/plugins/p-scroll/pscroll-1.js"></script>
<!--{ INTERNAL CHARTJS CHART JS }-->
<script src="/dashboard/assets/js/plugins/chart/Chart.bundle.js"></script>
<script src="/dashboard/assets/js/plugins/chart/utils.js"></script>
<!--{ Select2 js }-->
<script src="/dashboard/assets/js/plugins/select2/select2.full.min.js"></script>
<script src="/dashboard/assets/js/plugins/select2/select2.init.js"></script>
<!--{  INTERNAL Data tables js }-->
<script src="/dashboard/assets/js/plugins/datatable/jquery.dataTables.min.js"></script>
<script src="/dashboard/assets/js/plugins/datatable/dataTables.bootstrap5.min.js"></script>
<!--{ INTERNAL APEXCHART JS }-->
<script src="/dashboard/assets/js/apexcharts.js"></script>
<script src="/dashboard/assets/js/plugins/apexchart/irregular-data-series.js"></script>
<script src="/dashboard/assets/js/plugins/flot/jquery.flot.js"></script>
<script src="/dashboard/assets/js/plugins/flot/jquery.flot.fillbetween.js"></script>
<script src="/dashboard/assets/js/plugins/flot/chart.flot.sampledata.js"></script>
<script src="/dashboard/assets/js/plugins/flot/dashboard.sampledata.js"></script>
<!--{ INTERNAL Vector js }-->
<script src="/dashboard/assets/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="/dashboard/assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!--{ SIDE-MENU JS }-->
<script src="/dashboard/assets/js/plugins/sidemenu/sidemenu.js"></script>
<!--{ INTERNAL INDEX JS }-->
