        ...
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.html" class="logo-light">
                            <span class="logo-lg">
                                <img src="/dashboard/assets/images/logo-white.png" alt="logo">
                            </span>
                    <span class="logo-sm">
            ...
            <div class="app-search dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle" src="/dashboard/assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="32">
                                <div class="w-100">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle" src="/dashboard/assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                <div class="w-100">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="index.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            <span class="account-user-avatar">
                                <img src="/dashboard/assets/images/users/avatar-1.jpg" alt="user-image" width="32" class="rounded-circle">
                            </span>
